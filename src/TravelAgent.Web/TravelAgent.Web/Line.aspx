                    ...
                    <div class="linetop">
                        <div class="tit">
                            <h1><%=LineModel.LineName%><%=TravelAgent.Tool.CommonOprate.ShowLineState(LineModel.State) %></h1>
                                <span>
                                    <font style="color: #999">编号：L<%=LineModel.Id.ToString().PadLeft(6, '0')%></font> <%=LineModel.LineSubName%>
                                </span>
                        </div>
                        <!--左图片-->
                        <div class="linepic">
                        ...
                        <div class="linepre" id="divlineorder">
                            ...
                            <ul class="xinbox">
                                <li>
                                    <em>线路类型</em>
                                    <p><asp:Label ID="lblLineType" runat="server" Text=""></asp:Label></p>
                                </li>
                                <li><em>出发城市</em><p><asp:Label ID="lblCity" runat="server" Text=""></asp:Label></p>
                                </li>
                                <li>
                                    <em>行程天数</em><p><%=LineModel.DayNumber %>天</p>
                                </li>
                                <li style="border:0;"><em>往返交通</em><p><%=LineModel.TrafficIds.TrimStart(',').TrimEnd(',') %></p>
                                </li>
                                </ul>
                                <!--预订-->
                                <div class="yuding">
                                <form method="post" action="" onsubmit="return checkform(this);" >
                                 <div class="select" >
                                    ...
                                    <select id="ordertime" name="ordertime">
                                        <option value="">请选择出发日期</option><%=ShowDate()%>
                                    </select>
                                    </div>
                                   </div>

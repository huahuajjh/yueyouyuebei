<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="zcEmail.aspx.cs" Inherits="TravelAgent.Web.mTravel.user.zcEmail" %>
...
<body>
    ...
    <ul class="wx-ul-inputs">
        <li>
            <input type="text" placeholder="请输入您的注册邮箱" id="email">
        </li>
        <li>
    ...
    <div style="margin: 36px 45px;">
        ...
        <a href="zcPhone.aspx" class="wx-y-link">使用手机注册</a>
    </div>
